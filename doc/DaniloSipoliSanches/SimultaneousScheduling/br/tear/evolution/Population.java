/**
 * Classe respons�vel em armazenar as popula��es
 **/
...
public class Population implements Cloneable {
	 ...
	 * 
	 * @param index chromosome which must by replace
	 * @param tempChromosome reference to new chromosome
	 */
	...
	public String toString() {
		...
		if (fitnessFunction != null) {
			for (int i = 0; i < size(); i++) {
				populationText += population.get(i).toString() + " - " 	+ getFitnessValue(i) + "\n";
			}
		} else {
			for (int i = 0; i < size(); i++) {
