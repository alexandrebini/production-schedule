	...
	public void generateNewPopulation() {
		if (oldPopulation != null) {
			...
			for (int i = 0; i < (chromosomeGroup.size()/2); i++) {
				...
				auxCopyFirstChromosome.addAll((Vector<Object>) newPopulation.getChromosome(chromosomeGroup.get(i*2)));
				auxCopySecondChromosome.addAll((Vector<Object>) newPopulation.getChromosome(chromosomeGroup.get(i * 2 + 1)));
				...
				*/
				...
				/*
				 * Atualiza os cromossomos ap�s o cruzamento na popula��o
				 */
				/*
				 * System.out.println("\nCromosomomo Pai(" + i * 2 + "): \n" +
